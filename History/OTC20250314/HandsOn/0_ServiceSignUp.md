...
- [Dify](https://cloud.dify.ai/)にアクセス
...
- 右上の「ログイン」ボタンをクリック
- 「ログイン」画面で一番下の「ユーザー登録」リンクをクリック
- 「ユーザー登録」画面の「Continue with Google」をクリックして、Googleアカウントでログイン
- 「はじめに」画面で「ユーザー名」と「AI生成についての知識」「18歳以上かのチェック」を設定後、「完了」をクリック
