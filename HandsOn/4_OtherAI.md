...
- 左メニューの「Create Video」をクリック
- 次のいずれかの方法で動画を生成してみよう
  - (1) 「Text to Video/T2V」タブでテキストのみから動画を生成
    - (1-1) 「Model」の「T2V-01-Director」を「T2V-01」に変更
    - (1-2) 「Unleash Your Creativity! Share Your Story Here」を書かれたプロンプト欄に下記のプロンプト例をコピペ
    - (1-3) 「30」と書かれたアイコンをクリック
  - (2) 「Image to Video/I2V」タブで画像とテキストで動画を生成
    - (2-1) 「Model」の「I2V-01-Director」を「I2V-01-live」に変更
    - (2-2) 「Drag/Paste/Click to upload new photo」をクリックして下記の画像をアップロード(ドラッグ&ドロップでもOK)
    - (2-3) 「Unleash Your Creativity! Share Your Story Here」を書かれたプロンプト欄に下記のプロンプト例をコピペ
    - (2-4) 「30」と書かれたアイコンをクリック
...
- 中央部に表示された「テキスト生成モデル」をクリック。あるいは、上部メニューの「ワークスペース」をクリック後、「テキスト生成モデル」を選択
- 左ペインの「AIモデル」を「Meshy-5 Preview」から「Meshy-4」へ変更
