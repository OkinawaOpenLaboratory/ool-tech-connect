...
### (STEP1-2) ChatGPTのウェブ検索で情報をまとめてもらおう

**◆ハンズオン内容◆** : ChatGPTでウェブ情報から観光情報をまとめてもらう。

- プロンプト欄の地球アイコン(マウスを重ねると「ウェブを検索」と表示される箇所)をクリックし青い文字で「検索する」が表示されている状態にする
...
### (STEP1-3) ChatGPTにURLを指定して英文サイトを日本語で要約をしてもらう
...
[Note] コピペしない場合、改行は「Shift+Enter」で入力します。
...
### (STEP1-4) ChatGPTにダミーデータを作成させてみよう
...
## (STEP3) NotebookLMを使ってみよう

**◆ハンズオン内容◆** : NotebookLMを使って文献に対する質問をしてみよう

### (STEP3-1) 熱中症環境保健マニュアル2022のダウンロード
...
### (STEP3-2) NotebookLMにログイン

- [NotebookLM](https://notebooklm.google/)を右クリックして「新しいウィンドウで開く」
- 「NotebookLMを試す」をクリックして、Googleアカウントでログイン

※ Googleアカウント登録をしていない方→ [Googleアカウント作成](0_GoogleAccount.md)

### (STEP3-3) NotebookLMにPDFの内容を読み込ませて質問してみよう

- 「最初のノートブックを作成する」画面になったら「作成」ボタンをクリック
  - すでにノートブックを作成済みの場合は「＋新規作成」をクリック
- 「ソースを追加」ウィンドウが開くのでダウンロードしたPDFファイルをアップロード
...
## (STEP4) AI専用チップの効果を体験しよう

**◆ハンズオン内容◆** : AI専用チップを使った高速AIチャットを体験しよう
...
## (STEP5) 音声でAIチャットとやりとりしてみよう

**◆ハンズオン内容◆** : 音声会話でAIチャットを活用してみよう

### (STEP5-1) モバイル版ChatGPTに通訳になってもらおう
...
## (STEP6) チャットボットサイトを作成してみよう

**◆ハンズオン内容◆** : APIを使ったチャットボットサイトを作成してみよう

### (STEP6-1) Difyを使って熱中症対策を回答してくれるチャットボットを作成してみよう
...
## (STEP7) AIを使ってWebアプリを作成してみよう

**◆ハンズオン内容◆** : AIにWebアプリを作成してもらう

### (STEP7-1) Lovableにログイン
...
### (STEP7-2) Lovableで文字色を変更するWebアプリを作成してみよう
...
### (STEP7-3) Lovableで他にもいろいろ作成してみよう

Webアプリの作成

- 左上のハートマークをクリックして「Go to Dashboard」を選択
