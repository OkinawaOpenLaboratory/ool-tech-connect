...
- 「Sign in to Google AI Studio(Google AI Studioにログイン)」をクリック
- Googleアカウントでログイン
...
- ナレッジ(知識)を作成
  ...
  - (STEP3-1)でダウンロードした「heatillness_manual_full.pdf」を選択して「開く」
  - 「次へ」をクリック
...
### (STEP8-5) Lovableでいろいろなものを作成してみよう

- (STEP7-2)のウィンドウを開いたままの場合は、左上のハートマークをクリックして「Go to Dashboard」を選択
